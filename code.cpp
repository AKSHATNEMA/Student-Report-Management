...
class student
{
  ...
  public:
    void getdata(); // inputs all details of student 
    void showdata() const; // show details of a student
    void calculate();// calculates the grade of student
    int retrollno() const; // returns roll no of student
}; //class ends here


void student::calculate()
{  // calculates the grade of student
...
void create_student(); // Creates a Student record
...
{
  bool found=false; // checks whether the record is there or not
  student stud;
  fstream fl;
